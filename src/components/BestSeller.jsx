  ...
  return (
    <div className='my-10'>
        <div className='text-center py-8 text-3xl'>
           ...
           <p className='w-3/4 m-auto text-center text-sm sm:text-sm md:text-base text-gray-600'>Shop the favorites everyone is talking about. Quality, comfort, and style – all in one place.</p>
        </div>
           {/* Rendering Products */}
